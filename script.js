    ...
    if (valor.trim() !== "") {
        ...
        checkB.addEventListener("change", function() {
            if(checkB.checked) {
                ...
                document.getElementById("pendentes").appendChild(criar);
            }
        });
        ...
        const editarBton = document.createElement("button"); //editar item
        ...
        editarBton.addEventListener("click", function(){
            if(!editarBton.classList.contains("editando")) {
                ...
                container.replaceChild(novaEntrada, texto);
                ...
                if(novoValor !== "") {
                    ...
                    container.replaceChild(texto, novaEntrada);
